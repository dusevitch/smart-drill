...
# Form implementation generated from reading ui file '/home/jerry/ros_catkin_ws/src/smartdrill/ignore/main.ui'
#
...
if __name__ == "__main__":
    ...
    SmartDrill = QtWidgets.QMainWindow()
    ui = Ui_SmartDrill()
    ui.setupUi(SmartDrill)
    SmartDrill.show()
    sys.exit(app.exec_())
